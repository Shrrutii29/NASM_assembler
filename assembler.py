...
# symbol class with methods : add_symbol and display
class SymbolTable:
    def __init__(self):
        self.table = []
        self.sr_no = 0
...
def generate_symbolTable(filename):
    ...
    with open(filename, 'r') as file:
        for line in file:
            ...
            # handle comments and empty line
...
# help fetch required args from data section
...
# help fetch required args from bss section
...
# help fetch required args from text section
...
# text section
# opcode | mod_rm | value computation 
def process_text(addr, value, opcode, symboltable, arg1, arg2):
    ...
    if opcode != 'None':
        ...
        if instruction["mod_rm"]:
            ...
            elif (instruction['arg1'] == "reg32" and instruction['arg2'] == "mem"):
                rm = 0
                mod_rm = (rm << 6) | (dest << 3) | src
                
            elif (instruction['arg1'] == "mem" and instruction['arg2'] == "reg32"):
                rm = 0
                mod_rm = (rm << 6) | (src << 3) | dest      
